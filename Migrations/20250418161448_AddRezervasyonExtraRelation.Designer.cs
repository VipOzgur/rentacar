...
namespace Rentacar.Migrations
{
    ...
    [Migration("20250418161448_AddRezervasyonExtraRelation")]
    partial class AddRezervasyonExtraRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RezervasyonExtralar", b =>
                {
                    ...
                    b.HasKey("RezervasyonId", "ExtraId");

                    b.HasIndex("ExtraId");

                    b.ToTable("RezervasyonExtralar", (string)null);
                });
            ...
            modelBuilder.Entity("RezervasyonExtralar", b =>
                {
                    b.HasOne("Rentacar.Models.Extralar", null)
                        .WithMany()
                        .HasForeignKey("ExtraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rentacar.Models.Rezervasyon", null)
                        .WithMany()
